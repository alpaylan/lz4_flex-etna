...
| 005 | `dont_panic_on_drop_44e14b1_1` | proptest | `DropMatchesManualFinish` | `witness_drop_matches_manual_finish_case_small_payload` |
| 006 | `dont_panic_on_drop_44e14b1_1` | quickcheck | `DropMatchesManualFinish` | `witness_drop_matches_manual_finish_case_small_payload` |
| 007 | `dont_panic_on_drop_44e14b1_1` | crabcheck | `DropMatchesManualFinish` | `witness_drop_matches_manual_finish_case_small_payload` |
| 008 | `dont_panic_on_drop_44e14b1_1` | hegel | `DropMatchesManualFinish` | `witness_drop_matches_manual_finish_case_small_payload` |
...
- `witness_drop_matches_manual_finish_case_small_payload` — base passes, variant fails
- `witness_drop_matches_manual_finish_case_empty_payload` — base passes, variant fails
- `witness_drop_matches_manual_finish_case_repeated_bytes` — base passes, variant fails
